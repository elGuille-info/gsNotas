...
//
// Versión para .NET 6                                              (19/oct/22)
//
// Google.Apis.Auth v1.57.0
// Google.Apis.Core v1.57.0
// Google.Apis.Docs.v1 v1.57.0.2833
// Google.Apis.Drive.v3 v1.57.0.2831
// Newtonsoft.Json.Schema v3.0.14
//
                ...
                foreach (var nota in colNotas[folderNotas])
                {
                    ...
                    req = new Request
                    {
                        ...
                        UpdateTextStyle = new UpdateTextStyleRequest
                        {
                            ...
                            Fields = "*",
                            Range = new Google.Apis.Docs.v1.Data.Range { StartIndex = 1, EndIndex = nota.Length }
                        }
                    };
